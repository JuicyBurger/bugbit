...
const dynamicImport_1 = require("./dynamicImport");
const resolveActionModule_1 = require("./resolveActionModule");
let opsPromise = null;
let preflightPromise = null;
function loadOps(actionPath) {
    if (!opsPromise) {
        opsPromise = (0, dynamicImport_1.dynamicImport)((0, resolveActionModule_1.resolveActionModuleUrl)(actionPath, 'operations'));
    }
    return opsPromise;
}
function loadPreflight(actionPath) {
    if (!preflightPromise) {
        preflightPromise = (0, dynamicImport_1.dynamicImport)((0, resolveActionModule_1.resolveActionModuleUrl)(actionPath, 'preflight'));
    }
...
async function checkReviewPermissions(deps) {
    ...
    try {
        ...
        }, (0, github_1.getOctokit)(deps.githubToken));
    }
    catch (error) {
