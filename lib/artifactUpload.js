...
function streamLogArtifactName(runId) {
    return `bugbit-agent-stream-${runId}`;
}
async function uploadStreamLogArtifact(runId, streamLogPath) {
    ...
    return artifactClient.uploadArtifact(streamLogArtifactName(runId), [absolutePath], rootDirectory);
}
